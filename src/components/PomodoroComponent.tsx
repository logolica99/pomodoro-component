  ...
  return (
    <div className="min-w-[26rem] py-5">
      <div className="flex items-center justify-between">
        <p className="text-5xl font-bold text-zinc-400">25:00</p>
      ...
      <div className="mt-5 flex items-center justify-between">
        <div className="flex items-center gap-5">
          <p className="cursor-pointer border-b border-primary text-lg text-zinc-400">
            Pomodoro
          </p>
          <p className="cursor-pointer text-lg text-zinc-400">Short Break</p>
          <p className="cursor-pointer text-lg text-zinc-400">Long Break</p>
        </div>
        <div
          onClick={() => {
      ...
      {settingsOn && (
        <div className="mt-5 flex flex-col gap-3 ">
          ...
          <div className="pt-4">
            <button className=" w-full rounded-md border border-primary py-2   text-primary duration-150 ease-in hover:bg-zinc-700">
              Save
            </button>
          </div>
        </div>
